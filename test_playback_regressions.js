...
async function testDeadHostAndRefusedAddressAreDifferentFailures() {
  ...
  const previous = (typeof process !== "undefined" && process.env ? process.env.ALLOW_PRIVATE_PROXY_TARGETS : undefined);
  delete (typeof process !== "undefined" && process.env ? process.env.ALLOW_PRIVATE_PROXY_TARGETS : undefined);
  ...
  try {
    ...
    if (previous === undefined) delete (typeof process !== "undefined" && process.env ? process.env.ALLOW_PRIVATE_PROXY_TARGETS : undefined);
    else (typeof process !== "undefined" && process.env ? process.env.ALLOW_PRIVATE_PROXY_TARGETS : undefined) = previous;
  }
}
