...
function lazyllhttp () {
  const llhttpWasmData = (typeof process !== "undefined" && process.env ? process.env.JEST_WORKER_ID : undefined) ? require('../llhttp/llhttp-wasm.js') : undefined
  ...
  if ((typeof process !== "undefined" && process.env ? process.env.UNDICI_NO_WASM_SIMD : undefined) === '1') {
    useWasmSIMD = false
  } else if ((typeof process !== "undefined" && process.env ? process.env.UNDICI_NO_WASM_SIMD : undefined) === '0') {
    useWasmSIMD = true
  }
