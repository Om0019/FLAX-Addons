...
class EnvHttpProxyAgent extends DispatcherBase {
  ...
  constructor (opts = {}) {
    ...
    const HTTP_PROXY = httpProxy ?? process.env.http_proxy ?? (typeof process !== "undefined" && process.env ? process.env.HTTP_PROXY : undefined)
    if (HTTP_PROXY) {
    ...
    const HTTPS_PROXY = httpsProxy ?? process.env.https_proxy ?? (typeof process !== "undefined" && process.env ? process.env.HTTPS_PROXY : undefined)
    if (HTTPS_PROXY) {
  ...
  get #noProxyEnv () {
    return process.env.no_proxy ?? (typeof process !== "undefined" && process.env ? process.env.NO_PROXY : undefined) ?? ''
  }
}
